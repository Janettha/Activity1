package janettha.activity1.ActC.Adapters;
...
public class WheelmageAdapter extends CursorWheelLayout.CycleWheelAdapter {
    ...
    private Emociones listEmociones;
    private LayoutInflater inflater;
    private int gravity;

    public WheelmageAdapter(Context context, View view, String s) {
        listEmociones = new Emociones();
        this.context = context;
        this.listEmociones.Emociones(context, s);
    ...
    public View getView(View parent, int position) {
        ...
        ruta = Uri.parse(listEmociones.getEmocion(position).getUrl());
    ...
    public Emocion getItem(int position) {
        return listEmociones.getEmocion(position);
    }
}
